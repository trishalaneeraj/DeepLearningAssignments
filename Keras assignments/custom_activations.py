...
import numpy as np
#adding for arctan from theano rather than numpy
...
class funky(Layer):
    '''Funky version of a Rectified Linear Unit
    ...
    def __init__(self, alpha=0.3, **kwargs):
        ...
        self.alpha = alpha
        super(funky, self).__init__(**kwargs)

    # was in the original one and used it in the funky activation function
    # def call(self, x, mask=None):
    #     return K.relu(x, alpha=self.alpha)

    #added below for the arctan activation fucntion
